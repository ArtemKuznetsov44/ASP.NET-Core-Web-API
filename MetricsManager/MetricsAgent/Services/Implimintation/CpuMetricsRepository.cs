...
namespace MetricsAgent.Services.Implimintation
{
    public class CpuMetricsRepository : ICpuMetricsRepository
    {
        ...
        public CpuMetricsRepository(IOptions<DataBaseOptions> dataBaseOptions) => _dataBaseOptions = dataBaseOptions;
        ...
        public void Create(CpuMetric item)
        {
            ...
            { // Create new anonymous object with params, which we have already indicated in command:                                                       
                value = item.Value,
                time = item.Time
            });
        ...
        public IList<CpuMetric> GetAll()
        {
            ...
            // This method executes a command and returns some sample (object with type is IEnumerable):
        ...
        public CpuMetric GetById(int id)
        {
            ...
            CpuMetric metric = connection.QuerySingle<CpuMetric>("SELECT * FROM cpumetrics WHERE id = @id;", new
            {
                id = id
            });
            return metric;
        ...
        public IList<CpuMetric> GetByTimePeriod(TimeSpan fromTime, TimeSpan toTime)
        {
            ...
            List<CpuMetric> resList = connection.Query<CpuMetric>("SELECT * FROM cpumetrics WHERE time >= @fromTime and time <= @toTime;", new
            {
